...
public class ClippedView extends View {
    ...
    //Member variables for row and columns
    ...
    //Member variable for a rectangle RectF.
    ...
    public ClippedView(Context context, AttributeSet attributeSet){
        ...
        mRectF = new RectF(new Rect(mRectInset, mRectInset, mClipRectRight - mRectInset,
    ...
    private void drawClippedRectangle(Canvas canvas){
        ...
        /*
        Fill the canvas with white. with the clipped rectangle,
        this only draws inside the clipping rectangle.
        The rest of the surface remains grey.
        * */
        canvas.drawColor(Color.WHITE);

        /*
        Change the color to red and draw a line inside the
        clipping rectangle
        * */
        ...
        /*
        Set the color to blue and draw text aligned with right edge
    ...
    protected void onDraw(Canvas canvas){
        ...
        * */
        ...
        canvas.clipOutRect(2 * mRectInset, 2 * mRectInset, mClipRectRight - 2 * mRectInset, mClipRectBottom - 2 * mRectInset);

        /*
        The method clipRect(float, float, float, float, Region.Op.DIFFERENCE)
        was deprecated in API level 26. The recommended alternative
        method is clipOutRect(float, float, float, float), which is currently
        available in API level 26 and higher.
        * */
        ...
        //Draw the rectangle that uses a clipping region
        ...
        /*The method clipPath(path, Region.Op.DIFFERENCE) was deprecated
        * in API leve 26. The recommended alternative method is
        * clipOutPath(path), which is currently available in API level 26 and higher*/
        if (android.os.Build.VERSION.SDK_INT < Build.VERSION_CODES.O){
        ...
        //Use the intersection of 2 rectangles as the clipping region
        canvas.save();
        ...
        //Draw text with a translate and skew transformation applied.
        canvas.save();
