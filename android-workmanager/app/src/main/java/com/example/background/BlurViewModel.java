...
import static com.example.background.Constants.*;

import java.util.List;

public class BlurViewModel extends ViewModel {
    private Uri mImageUri;
    //Instance variable for the WorkInfo class
    ...
    void applyBlur(int blurLevel) {
        ...
        for (int i = 0; i < blurLevel; i++){
            ...
            * After the first blur operation, the input will be
            * the output of the previous blur operation.*/
            if (i == 0)
    ...
    /*
    * Create the input data bundle which includes the Uri to
    * operate on
    * @return Data which contains the Image Uri as a string*/
    ...
    //Cancel the work using the work's unique name
    void cancelWork(){
