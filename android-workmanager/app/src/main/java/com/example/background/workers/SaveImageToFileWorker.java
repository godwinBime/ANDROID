...
public class SaveImageToFileWorker extends Worker {
    ...
    public SaveImageToFileWorker(@NonNull Context appContext,
                                 @NonNull WorkerParameters workParams){
    ...
    public Result doWork(){
        ...
        /*Make a notification when the work starts
         * and slows down the work so that it's easier to
        ...
        try {
            ...
            String outputUri = MediaStore.Images.Media.insertImage(resolver, bitmap, TITLE,
