...
public class BlurWorker extends Worker {
    ...
    public Worker.Result doWork(){
        ...
        /*Makes a notification when the work starts and slows down
        * the work so that it's easier to see each WorkRequest start,
        * even on emulated devices*/
        ...
        try {
            ...
            /**
             * Technically WorkManage will return Result.failure()
             * but it's best to be explicit about it.
             * Thus if there were errors, we're going to return FAILURE.**/
