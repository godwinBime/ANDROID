...
public class MainActivity extends AppCompatActivity
    ...
    //Holds copies of the accelerometer and magnetometer data
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get the display from the window manager
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch (mDisplay.getRotation()){
            ...
            case Surface.ROTATION_270:
                SensorManager.remapCoordinateSystem(rotationMatrix, SensorManager.AXIS_MINUS_Y, SensorManager.AXIS_MINUS_X, rotationMatrixAdjusted);
                break;
        }
        ...
        //Reset the values to be invisible each time
